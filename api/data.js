...
export default async function handler(req, res) {
  try {
    ...
    if (!db || !db.players) { // Verifica si la base de datos está vacía o corrupta
      db = getInitialData();
...
function getInitialData() {
    const players = [
        ...
        { id: 7, name: 'Kevin', position: 'LTD', skill: 'Resistencia', number_current: null, number_new: null, isExpelled: false },
        ...
        { id: 12, name: 'Roger', position: 'EI', skill: 'Regate', number_current: null, number_new: null, isExpelled: false },
